...
function Header() {
    ...
    return (
        <div className="header">
            ...
            <Avatar src="https://yt3.ggpht.com/yti/ANoDKi78o5UirI8NFX511Kn-iNpx5msdTTuDVQJZC-vR-Q=s88-c-k-c0x00ffffff-no-rj-mo" alt="sidharthan" />
            </div>
        </div>
    );
}
